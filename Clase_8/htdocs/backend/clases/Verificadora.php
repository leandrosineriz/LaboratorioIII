...
class Verificadora implements IMiddleware{
    ...
    public static function TraerCds()
    {
        ...
        $response='<table class="table table-responsive"><thead class="thead-dark"><tr>'+
        '<th scope="col">Nombre</th><th scope="col">Artista</th><th scope="col">año</th><th scope="col">Handle</th></tr></thead>'+
